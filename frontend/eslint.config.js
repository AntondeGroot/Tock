...
module.exports = defineConfig([
  ...
  {
    // RATCHET: board.ts is still over the 400-line file cap (434 counted) after a long series of
    ...
    // functions all pass, so those pins are gone. TODO: extract ~34 more lines to reach 400, then
    // delete this override entirely.
    files: ['src/app/features/board/board.ts'],
    rules: {
      'max-lines': ['error', { max: 434, skipBlankLines: true, skipComments: true }],
    },
  },
  {
